...
'cookie_pre' => 'GFYBA_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/cms/pc/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/cms/pc/statics/js/', //CDN JS
'css_path' => 'http://localhost/cms/pc/statics/css/', //CDN CSS
'img_path' => 'http://localhost/cms/pc/statics/images/', //CDN img
'app_path' => 'http://localhost/cms/pc/',//动态域名配置地址
'bjh_path' => 'http://localhost/cms/pc/statics/assets/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'rKIgqYnhV8M1gHBC4paP', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/cms/pc/phpsso_server',	//接口地址
'phpsso_auth_key' => 'tYr1dE9zzO5wfNA9kUc7SLAZRngNcUGs', //加密密钥
