					...
					<div class="post">
						<div class="uk-grid">
							...
							<div class="uk-width-medium-2-3">
								<h2 class="title"><a href="<?php echo $r['url'];?>" target="_blank" style="color:#78bee1"><?php echo $r['title'];?></a></h2>
								<div class="meta">
									<span><i class="uk-icon-time"></i><?php echo date('Y-m-d H:i:s',$r[inputtime]);?></span>
								</div>
								<div style="height: 10px"></div>	
								<div class="entry"><?php echo str_cut($r['description'],255);?></div>
								<div style="height: 10px"></div>	
								<div class="button"><a href="<?php echo $r['url'];?>" target="_blank" style="color: #505050">阅读全文</a></div>
							</div>
						</div>
					</div>
